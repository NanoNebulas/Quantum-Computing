## up qark mass 3.9×10^-30 kg (kilograms)
## up qark Characteristic length L from L = h/(mc):    560 fm (femtometers)
#### Relativistic energy E from E = mc^2:
### 3.5×10^-13 J (joules)
### 2.2 MeV (megaelectronvolts)
###Characteristic time T from T = h/(mc^2):
 #### 1.9×10^-21 seconds
###Current I caused by the charge flowing in one second from I = Q/t:
 #####| 1.1×10^-19 A (amperes)   ## +2/3 charge
...
$PDL::BIGPDL=1;
 ...
 $photons = 7134; ### [Density] electron 4178 divided by 2 to 2089 ### upquark 7126 ### 7134 divisable by 2 and by 3
