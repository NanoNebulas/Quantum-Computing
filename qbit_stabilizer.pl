...
$zz = sin cos$z*$x*rvals($z*$x);
 ...
 $colorc = zeros(1000000);
  ...
  $matrixa->range([4178],[4178]) .= $xx = 100*$xx; 
  ...
  $colorc->range([12534],[4178]) .= $r ;


  $colora->range([4178],[4178]) .= $r; 
  $colorb->range([4178],[4178]) .= $r;
  $colorc->range([4178],[4178]) .= $r;
